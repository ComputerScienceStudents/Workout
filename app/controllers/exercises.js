...
exports.all = function(req, res) {
    Exercise.find().sort('-created').populate('user', 'name username').exec(function(err, exercises) {
        if (err) {
            ...
            // fake exercises
            var predefined = [];
            predefined.push(new Exercise({title: 'push-ups', description: 'A push-up is a common calisthenics exercise performed in a prone position by raising and lowering the body using the arms. Push-ups exercise the pectoral muscles, triceps, and anterior deltoids, with ancillary benefits to the rest of the deltoids, serratus anterior, coracobrachialis and the midsection as a whole.',
                video: 'http://www.youtube.com/watch?v=FtcKhNzopTo', minature: 'http://i1.ytimg.com/vi/FtcKhNzopTo/mqdefault.jpg', categories:['Chest']}));
            predefined.push(new Exercise({title: 'pull-ups', description: 'A pull-up is a variety of upper-body compound pulling motions for the purpose of exercise. The pull-up has two main methods of execution; the first is with a pronated (overhand) grip and the second is with a supinated (underhand) grip.',
                video: 'http://www.youtube.com/watch?v=blpuO2vJo38', minature: 'http://i1.ytimg.com/vi/blpuO2vJo38/mqdefault.jpg', categories: ['Abdominal', 'Chest']}));
            predefined.push(new Exercise({title: 'squats', description: 'In strength training, the squat is a compound, full body exercise that trains primarily the muscles of the thighs, hips and buttocks, quads (vastus lateralus medialis and intermedius), hamstrings, as well as strengthening the bones, ligaments and insertion of the tendons throughout the lower body.',
                video: 'http://www.youtube.com/watch?v=xK9jzjsTJts', minature: 'http://i1.ytimg.com/vi/xK9jzjsTJts/mqdefault.jpg', categories: ['Legs', 'Abdominal']}));            
